...
public class TabFragment5 extends Fragment{
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v;
        v= inflater.inflate(R.layout.tab_fragment_5, container, false);
        ...
        ArrayList<String[]> decode_image=dbHelper.get_image_5(equip_code);
    ...
    public String saveImage(Bitmap myBitmap){
        ...
        if(!wallpaperDirectory.exists()){
            ...
            dbHelper=new DBHelper(this.getContext(),id,null,1);
            dbHelper.add_image_5(encodingText, equip_code);
